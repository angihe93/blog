...
In week 1 we've already covered a lot of grounds, including creating a game app with Vite & Express (or Vite-Express), that connects to a database on Supabase via Drizzle ORM, and implements web sockets for live move streaming on browsers.
